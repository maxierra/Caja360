-- preload_products compatible con IMG_DB.csv y el importador CSV de Supabase.
-- Usar nombres en minúsculas (sin comillas): el import matchea productId → productid, etc.
